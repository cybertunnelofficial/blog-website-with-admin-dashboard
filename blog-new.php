        ...
        <div class="container">
          ...
          <div class="row blog-entries element-animate">
            <div class="col-md-12 col-lg-8 main-content">
              ...
              <a class="category mb-5" href="#"><?php // fetchCategory($connection, $getpost['category_id'])?></a>
...
<!--                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium nam quas inventore, ut iure iste modi eos adipisci ad ea itaque labore earum autem nobis et numquam, minima eius. Nam eius, non unde ut aut sunt eveniet rerum repellendus porro.</p>
              ...
              <div class="pt-5">
                <p>Categories:  <a href="#"><?php //fetchCategory($connection, $getpost['category_id'])?></a> Tags: <a href="#"><?php // fetchTag($connection, $getpost['tag_id'])?></a></p>
              </div>
              <div class="pt-5">
